...
<div class="container">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Société → Ville → Produits</p>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card stat-card-success">
            ...
            <div class="stat-value" id="statAvg"><?= number_format($stats['avg_price'], 2) ?> €</div>
            <div class="stat-label">Prix Moyen</div>
        </div>
        
        <div class="stat-card stat-card-warning">
            <div class="stat-icon"><i class="fas fa-arrow-down"></i></div>
            <div class="stat-value" id="statMin"><?= number_format($stats['min_price'], 2) ?> €</div>
            <div class="stat-label">Prix Min</div>
        </div>
        
        <div class="stat-card stat-card-danger">
            <div class="stat-icon"><i class="fas fa-arrow-up"></i></div>
            <div class="stat-value" id="statMax"><?= number_format($stats['max_price'], 2) ?> €</div>
