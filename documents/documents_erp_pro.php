...
.f-select,.f-input{width:100%;padding:12px 16px;background:rgba(15,23,38,0.72);border:1.5px solid var(--bord);border-radius:12px;color:var(--text);font-family:var(--fb);font-size:14px;font-weight:600;transition:all 0.3s}
...
@media(max-width:768px){
    ...
    .ks{padding:12px 10px;gap:10px;border-radius:14px;align-items:center}
    ...
    .pb{padding:12px}
    .form-grid{grid-template-columns:1fr;gap:8px;margin-bottom:12px}
    .f-select,.f-input{padding:11px 12px;font-size:13px;border-radius:12px}
    .btn{padding:11px 14px;font-size:11px;border-radius:12px;justify-content:center}
    .docs-grid{grid-template-columns:1fr;gap:10px;margin-top:12px}
    .doc-card{padding:14px;border-radius:16px}
    .enc-badge{top:10px;right:10px;padding:4px 8px;font-size:9px;border-radius:8px}
    .doc-head{gap:10px;margin-bottom:10px}
    .doc-icon{font-size:34px}
    .doc-title{font-size:14px;margin-bottom:4px}
    .doc-ref{font-size:10px;padding:3px 8px;border-radius:999px}
    .conf-badge{padding:5px 10px;font-size:9px;margin-bottom:10px}
    .doc-meta{gap:6px;margin-bottom:10px}
    .meta-i{font-size:10px}
    .doc-foot{padding-top:10px}
    .doc-date{font-size:10px}
    .doc-actions{gap:6px}
    .act-btn{width:32px;height:32px;border-radius:10px;font-size:12px}
    .pagination{gap:8px;margin-top:16px}
    .pg-link{padding:8px 12px;font-size:11px;border-radius:10px}
}
</style>
</head>
<body>
